...
func TestCheckFilePermissions(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("checkFilePermissions is not called on Windows; runConfigCheck skips the check entirely")
	}
...
func TestValidateAPIKey(t *testing.T) {
	t.Run("valid 32-char hex key returns OK message with HideKeyExceptLastFiveChars", func(t *testing.T) {
		msg, err := validateAPIKey("abcdef1234567890abcdef1234567890")
		require.NoError(t, err)
		assert.Contains(t, msg, "67890", "should show last 5 chars")
